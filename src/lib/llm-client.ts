...
LANGUAGE HANDLING:
- The conversation may be in Hindi, English, or a mix of both (Hinglish).
- Auto-detect the language(s) used in the transcript.
- Regardless of the input language, ALWAYS generate all clinical notes, SOAP entries, prescriptions, and summary in English.
- Accurately translate Hindi medical terms, colloquial descriptions, and Hinglish phrases into proper English medical terminology.
- Examples: "seene mein dard" → "chest pain", "sans phoolna" → "shortness of breath", "BP ki dawai" → "antihypertensive medication", "sugar ki bimari" → "diabetes mellitus"
